...
if ( $mysql == true ) {
	$sqlstatus = "INSERT INTO `vedica_admission_2017`.`admission_section_status` (`application_id`, `personal_details_status`, `contact_details_status`, `academic_details_status`, `work_ex_details_status`, `reference_details_status`, `additional_details_status`, `document_details_status`, `last_update_date`) VALUES (
			'".$applicationid."',
			'".$personalstatus."',
			'".$contactstatus."',
			'".$academicestatus."',
