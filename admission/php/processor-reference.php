...
if ( $mysql == true ) {
	$sqlrefree = "INSERT INTO `vedica_admission`.`users_reference_details` (`application_id`, `title_of_refree`, `name_of_refree`, `organization`, `designation`, `phone_number`, `email_id`, `capacity_of_knowing`) VALUES (
